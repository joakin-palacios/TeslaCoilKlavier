...
static picotts_language_t currentLanguage = PICOTTS_LANG_EN_US;
...
#ifdef CONFIG_PICOTTS_MULTILANG
extern const char en_ta_bin_start[] asm("_binary_picotts_en_ta_bin_start");
extern const char en_sg_bin_start[] asm("_binary_picotts_en_sg_bin_start");
extern const char de_ta_bin_start[] asm("_binary_picotts_de_ta_bin_start");
extern const char de_sg_bin_start[] asm("_binary_picotts_de_sg_bin_start");
extern const char es_ta_bin_start[] asm("_binary_picotts_es_ta_bin_start");
extern const char es_sg_bin_start[] asm("_binary_picotts_es_sg_bin_start");
#endif
...
static const void *find_ta_bin_start()
{
  ...
  {
    case PICOTTS_LANG_DE_DE: return de_ta_bin_start;
    case PICOTTS_LANG_ES_ES: return es_ta_bin_start;
    case PICOTTS_LANG_EN_US:
    default: return en_ta_bin_start;
  }
#else
  return ta_bin_start;
#endif
...
static const void *find_sg_bin_start()
{
  ...
  switch (currentLanguage)
  {
    case PICOTTS_LANG_DE_DE: return de_sg_bin_start;
    case PICOTTS_LANG_ES_ES: return es_sg_bin_start;
    case PICOTTS_LANG_EN_US:
    default: return en_sg_bin_start;
  }
#else
  return sg_bin_start;
#endif
...
void picotts_set_language(picotts_language_t language)
{
...
static void picotts_cooperative_delay(unsigned *work_count)
{
  if (++(*work_count) >= PICOTTS_WORK_BUDGET)
  {
    *work_count = 0;
    vTaskDelay(1);
  }
...
static void esp_pico_run(void *)
{
  ...
  while(!error)
  {
    ...
    while (xQueuePeek(textQ, &c, 0) == pdPASS)
    {
      ...
      picotts_cooperative_delay(&work_count);
      if (ret)
      {
